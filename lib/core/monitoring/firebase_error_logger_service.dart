...
class FirebaseErrorLoggerService {
  // Singleton instance
  static final FirebaseErrorLoggerService _instance =
      FirebaseErrorLoggerService._internal();

  static FirebaseErrorLoggerService get to => _instance;
