...
class AuthFailure extends Failure {
  ...
  AuthFailure.fromException(AuthException e)
    : this(message: e.message, statusCode: e.statusCode);
}

class AuthCancelledByUserFailure extends Failure {
  const AuthCancelledByUserFailure()
    : super(message: 'Sign-in cancelled', statusCode: 0, errors: const []);

  const AuthCancelledByUserFailure.fromException(
    AuthCancelledByUserException _,
  ) : this();
}
