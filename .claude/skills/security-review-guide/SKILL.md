---
name: security-review-guide
description: Security-focused code review checklist based on OWASP Top 10 — authentication, authorization, input validation, injection, secrets handling, transport, and dependency risks. Use when performing a security review, auditing auth or data-handling code, or checking a change for vulnerabilities.
---
